...
export const analysisInventoryMock: AnalysisInventoryViewModel = {
  slowMedicines: {
    rows: [
      { id: "1", name: "Paracetamol 500mg", notSaleFromDays: 120 },
      { id: "2", name: "Amoxicillin Syrup", notSaleFromDays: 90 },
    ],
  },
  expiryMedicines: {
    rows: [
  ...
  rotation: {
    bars: [
      { id: "1", title: "sale", invoicesNumber: 74 },
      { id: "2", title: "purchase", invoicesNumber: 80 },
      { id: "3", title: "return", invoicesNumber: 62 },
      { id: "4", title: "damage", invoicesNumber: 37 },
    ],
    totalValue: {
      value: "4.2x",
