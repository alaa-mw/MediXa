...
export const useTradeDrugSearch = (debouncedSearchTerm: string, limit: number = 20) => {
  ...
  const { data: searchResults, isLoading, isFetching } = useGetWithParamsWithoutState<any>(
